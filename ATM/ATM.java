...
class Data{
 ...
 class ATMop {
    ...
    ATMop(){
     ...
     public void op(){
         System.out.println("Please Input here valid pin");
         ...
         if(map.containsKey(pin)){
             ...
             System.out.println("At first create a new account");
             System.out.println("Please set pin");
             System.out.println("Set the pin greater than 2  and less than 5");
             ...
             if(Integer.toString(setpin).length() < 5 && 2<Integer.toString(setpin).length() ){
                 ...
                 System.out.println("Sorry! Invalid pin system terminate");
             }
         }
     }
